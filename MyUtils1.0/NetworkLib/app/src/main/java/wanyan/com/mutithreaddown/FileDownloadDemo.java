package wanyan.com.mutithreaddown;
...
import wanyan.com.networklib.R;
...
public class FileDownloadDemo extends Activity {
    ...
    private void download() {
        ...
        downloadProgressBar.setProgress(0);
        //启动文件下载线程
        new downloadTask(downloadUrl.getText().toString(), Integer.valueOf(downloadTN), dowloadDir + fileName).start();
    }

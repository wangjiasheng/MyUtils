...
public final class CaptureActivity extends Activity implements
	...
	public static final int Result_Code=100000;
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		String scanString=ResultParser.parseResult(rawResult).toString();
		Intent intent=new Intent();
		intent.putExtra(CaptureActivity.Result_key,scanString);
		setResult(CaptureActivity.Result_Code, intent);
		finish();
	}

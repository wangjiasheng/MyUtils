...
import com.wjs.view.SingleButton;
import com.wjs.view.SingleButton.SingleButtonClickListener;
import com.wjs.wenyan.myutils.R;

public class SingleButtonActivity extends Activity implements SingleButtonClickListener
{
	@Override
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		SingleButton view = (SingleButton) findViewById(R.id.singlebutton);
